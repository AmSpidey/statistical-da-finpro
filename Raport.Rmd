...
sum <- summary(reg)
predictors.protein <- names(coef(reg,5))[-1] # TABLE OF THE MOST IMPORTANT 5 PREDICTORS FOR PROTEIN
```
...
predictors.cancer <- colnames(subData[-101]) # TABLE OF THE MOST IMPORTANT 100 PREDICTORS FOR CANCER
